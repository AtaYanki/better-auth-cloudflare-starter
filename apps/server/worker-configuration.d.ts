/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 7237fa9e3b64bfeafd7deef501914f08)
// Runtime types generated with workerd@1.20260603.1 2025-06-15 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	CORS_ORIGIN: "https://your-frontend-domain.com" | "http://localhost:3001";
	BETTER_AUTH_URL: "https://your-api-domain.com" | "http://localhost:3000";
	POLAR_SUCCESS_URL: "https://your-frontend-domain.com/success" | "http://localhost:3001/success";
	SYNC_CHANNEL: DurableObjectNamespace<import("./src/index").SyncChannelDO>;
	// Secrets (provided via `wrangler secret` / `.dev.vars`; `wrangler types`
	// only emits these when a `.dev.vars` file is present at generation time).
	DATABASE_URL: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "SyncChannelDO";
	}
	interface ProductionEnv {
		...
		POLAR_SUCCESS_URL: "https://your-frontend-domain.com/success";
		SYNC_CHANNEL: DurableObjectNamespace<import("./src/index").SyncChannelDO>;
		DATABASE_URL: string;
		BETTER_AUTH_SECRET: string;
		RESEND_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "CORS_ORIGIN" | "BETTER_AUTH_URL" | "POLAR_SUCCESS_URL">> {}
}
